...
DELTA_MIN = 20
DELTA_MAX = 180
NEW_TOKENIZER_DELTA_MIN = 20
NEW_TOKENIZER_DELTA_MAX = 260

OUTPUT_TOKEN_TOLERANCE = 16
INPUT_CLOSE_FRAC = 0.25
INPUT_CLOSE_FLOOR = 8
OUTPUT_CLOSE_FRAC = 1.00
OUTPUT_CLOSE_FLOOR = 8
...
def _count_close(non_stream: dict[str, Any], count_result: dict[str, Any]) -> bool:
    ...
    if actual is None or counted is None:
        return bool(count_result.get("error"))
